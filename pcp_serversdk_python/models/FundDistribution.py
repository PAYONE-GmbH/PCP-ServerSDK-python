...
class FundDistribution:
    """Instructions for distributing funds to multiple sellers/partners in a
    marketplace context."""

    accountId: str
    """Unique identifier of the beneficiary (seller/partner/sub-account) to receive 
    funds."""

    amount: int
    """Amount in cents and always having 2 decimals, in the currency of the original 
    transaction."""

    type: FundDistributionType
    """Classification or purpose of the fund distribution to the receiving account 
