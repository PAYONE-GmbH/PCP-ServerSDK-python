...
class AvsResult(str, Enum):
    ...
    B = "B"  # Street address match for international transactions—Postal code not
    # verified
    ...
    # participant
    H = "H"  # Billing address and postal code match, cardholder name is incorrect
    # (Amex)
    ...
    P = "P"  # Postal codes match for international transaction—Street address not
    # verified
