...
class GetCheckoutsQuery:
    def __init__(self):
        ...
        self.include_checkout_status: Optional[List[str]] = (
            None  # Replace str with StatusCheckout if defined
        )
        self.include_extended_checkout_status: Optional[List[str]] = (
            None  # Replace str with ExtendedCheckoutStatus if defined
        )
        self.include_payment_channel: Optional[List[str]] = (
            None  # Replace str with PaymentChannel if defined
        )
    ...
    def set_from_checkout_amount(
        self, from_checkout_amount: int
    ) -> "GetCheckoutsQuery":
    ...
    def set_from_collected_amount(
        self, from_collected_amount: int
    ) -> "GetCheckoutsQuery":
    ...
    def set_from_cancelled_amount(
        self, from_cancelled_amount: int
    ) -> "GetCheckoutsQuery":
    ...
    def set_from_chargeback_amount(
        self, from_chargeback_amount: int
    ) -> "GetCheckoutsQuery":
        self.from_chargeback_amount = from_chargeback_amount
        return self

    def set_to_chargeback_amount(
        self, to_chargeback_amount: int
    ) -> "GetCheckoutsQuery":
    ...
    def toQueryMap(self) -> Dict[str, str]:
        ...
        if self.include_payment_product_id is not None:
            query["includePaymentProductId"] = ",".join(
                map(str, self.include_payment_product_id)
            )
        ...
        if self.include_extended_checkout_status is not None:
            query["includeExtendedCheckoutStatus"] = ",".join(
                self.include_extended_checkout_status
            )
